        ...
        <div class="layout">
			<section class="inner">
				<ul class="grid">
					<li class="grid-tile">
						<div class="item">
							<div class="item-img" style="background-image: url('http://placehold.it/250x250/ffffff/000000/?text=no%20image'); background-size: auto auto; background-size: 150%; background-position: center 30%;"></div>
							<div class="item-pnl">
					...
					<li class="grid-tile">
						<div class="item">
							<div class="item-img" style="background-image: url('http://placehold.it/250x250/ffffff/000000/?text=no%20image'); background-size: auto auto; background-size: 150% 150%;"></div>
							<div class="item-pnl">
								<div class="pnl-wrapper">
									<div class="pnl-description">
										<span class="pnl-label">Product Name</span>
					...
					<li class="grid-tile">
						<div class="item">
							<div class="item-img" style="background-color: #ffff00; background-image: url('http://placehold.it/250x250/ffffff/000000/?text=no%20image'); background-size: contain;"></div>
							<div class="item-pnl">
								<div class="pnl-wrapper">
									<div class="pnl-description">
										<span class="pnl-label">Product Name</span>
					...
					<li class="grid-tile">
						<div class="item">
							<div class="item-img" style="background-color: #EEEEEE; background-image: url('http://placehold.it/250x250/ffffff/000000/?text=no%20image'); background-size: 50% 50%;"></div>
							<div class="item-pnl">
								<div class="pnl-wrapper">
									<div class="pnl-description">
										<span class="pnl-label">Product Name</span>
					...
					<li class="grid-tile">
						<div class="item">
							<div class="item-img" style="background-image: url('http://placehold.it/250x250/ffffff/000000/?text=no%20image'); background-size: cover;"></div>
							<div class="item-pnl">
								<div class="pnl-wrapper">
									<div class="pnl-description">
										<span class="pnl-label">Product Name</span>
